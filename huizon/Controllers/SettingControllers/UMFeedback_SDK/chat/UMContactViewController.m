...
- (void)setupCancelBtn {
    ...
    UIBarButtonItem *cancelButtonItem = [[[UIBarButtonItem alloc] initWithCustomView:cancelBarBtn] autorelease];
...
- (void)setupSaveBtn {
    ...
    UIBarButtonItem *saveButtonItem = [[[UIBarButtonItem alloc] initWithCustomView:saveBarBtn] autorelease];
