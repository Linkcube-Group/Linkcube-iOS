...
{
    return [[self elementForName:@"PERSONSTATE"] stringValue];
}

- (void)setPersonstate:(NSString *)personstate
{
    XMPP_VCARD_SET_STRING_CHILD(personstate,@"PERSONSTATE");
}

- (NSString *)birthday
{
    return [[self elementForName:@"BIRTHDAY"] stringValue];
}
- (void)setBirthday:(NSString *)birthday
{
   XMPP_VCARD_SET_STRING_CHILD(birthday,@"BIRTHDAY");
}
@end
